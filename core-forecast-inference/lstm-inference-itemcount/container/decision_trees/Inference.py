...
# s3_output = 's3://chick-fil-a-bucket/forecast/lstm/temp_files/'

# csv_bucket = 'chick-fil-a-bucket'
# athena_csv_filepath='forecast/lstm/temp_files/'



# #model properties
# bucket_mp = 'chick-fil-a-bucket'
# mp_path = 'forecast/lstm/model-object/'
# #h5 file
# bucket_m = 'chick-fil-a-bucket'
# h5_path = 'forecast/lstm/model-object/'

# #upload predictions
# upload_bucket='chick-fil-a-bucket'
...
def sales_inference(store_num,bucket_name,athena_csv_filepath,mp_path,h5_path,upload_path):
    ...
    mp_path="model-object-retraining-jul21"
    ...
    h5_path="model-object-retraining-jul21"
    model_fname = h5_path+str(i)+'_dollars_allproducts/'+str(i)+'_dollars_allproducts.h5'
