# core-forecast-15min-breakdown-redundancy-dollarsandtrans
...
2. Once in the virtualenv run `python core_forecast_fifteenmin_breakdown_redundancy_dollarsandtrans/lambda_function.py`
