# core-forecast-15min-breakdown-redundancy-itemanding
...
2. Once in the virtualenv run `python core_forecast_fifteenmin_breakdown_redundancy_itemanding/lambda_function.py`
