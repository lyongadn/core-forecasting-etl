# core-forecast-slack-alert-redundancy-inference-qc
...
2. Once in the virtualenv run `python core_forecast_slack_alert_redundancy_inference_qc/lambda_function.py`
