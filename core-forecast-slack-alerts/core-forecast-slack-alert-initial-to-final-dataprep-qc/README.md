# core-forecast-slack-alert-initial-to-final-dataprep-qc
...
2. Once in the virtualenv run `python core_forecast_slack_alert_initial_to_final_dataprep_qc/lambda_function.py`
