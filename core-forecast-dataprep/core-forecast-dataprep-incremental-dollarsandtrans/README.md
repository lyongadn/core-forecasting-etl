# core-forecast-dataprep-incremental-dollarsandtrans
...
2. Once in the virtualenv run `python core_forecast_dataprep_incremental_dollarsandtrans/lambda_function.py`
